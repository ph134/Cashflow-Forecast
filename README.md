...
## Separate Quotation Workflow App

The workflow tool is now fully separate from cashflow.

- Cashflow app: `index.html`
- Quotation workflow app: `workflow.html`

Open `workflow.html` directly in a browser to use the standalone workflow studio.
